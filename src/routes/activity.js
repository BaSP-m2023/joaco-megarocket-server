...
router
  .get('/', (req, res, next) => verifyToken(req, res, ['TRAINER'], next), activitiesController.getAllActivities)
  .get('/:id', (req, res, next) => verifyToken(req, res, ['TRAINER'], next), activitiesController.getActivityByID)
